      ...
      <div className="graphics">
        ...
        <div className="socmed">
          ...
          <div className="wrapper-imgs">
            <a href="https://www.facebook.com/rmeitaly/" target="_blank">
              <img src="assets/icons/facebook.png" alt="" />
            </a>
            <a href="https://www.instagram.com/romeyiow/" target="_blank">
              <img src="assets/icons/instagram.png" alt="" />
            </a>
            <a href="https://www.linkedin.com/in/thereliablerome" target="_blank">
